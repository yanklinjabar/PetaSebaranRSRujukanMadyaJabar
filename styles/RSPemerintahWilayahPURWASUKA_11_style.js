...
var style_RSPemerintahWilayahPURWASUKA_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("RSUD Strata Madya") !== null) {
        labelText = String(feature.get("RSUD Strata Madya"));
    }
